...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_math_23fc_rustbuffer_alloc(size, status)
        }

        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_math_23fc_rustbuffer_free(buf, status)
        }

        internal fun reserve(buf: RustBuffer.ByValue, additional: Int) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_math_23fc_rustbuffer_reserve(buf, additional, status)
        }
    }
...
internal interface _UniFFILib : Library {
    ...
    fun math_23fc_add(a: Int,b: Int,
    uniffi_out_err: RustCallStatus
    ): Int

    fun ffi_math_23fc_rustbuffer_alloc(size: Int,
    uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_math_23fc_rustbuffer_from_bytes(bytes: ForeignBytes.ByValue,
    uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_math_23fc_rustbuffer_free(buf: RustBuffer.ByValue,
    uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_math_23fc_rustbuffer_reserve(buf: RustBuffer.ByValue,additional: Int,
    uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
fun add(a: UInt, b: UInt ): UInt {
    val _retval = 
    rustCall() { status ->
    _UniFFILib.INSTANCE.math_23fc_add(a.lower(), b.lower() ,status)
}
